...
describe("Online game", () => {
    ...
    it("Doesn't prompt to rejoin game", () => {
        cy.get("[data-rejoin-game]").should("not.exist");
    });
    ...
    it("Joins the created online game.", () => {
        ...
        cy.get("[data-games-list] tbody tr")
            .eq(gameToJoinIdx)
    ...
    it("Can rejoin the game after a page reload", () => {
        cy.visit("/");
        cy.get("[data-rejoin-game]").click();
